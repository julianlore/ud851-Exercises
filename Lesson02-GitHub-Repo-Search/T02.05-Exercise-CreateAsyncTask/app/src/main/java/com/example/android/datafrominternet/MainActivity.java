...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        GithubQueryTask query = new GithubQueryTask(); // Make new GithubQueryTask and execute with url
    ...
    private class GithubQueryTask extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls){
            try{
                String searchResults = NetworkUtils.getResponseFromHttpUrl(urls[0]); // Search given URL
        ...
        protected void onPostExecute(String s){
            mSearchResultsTextView.setText(s); // Could check if String is empty/null
        }
    }
