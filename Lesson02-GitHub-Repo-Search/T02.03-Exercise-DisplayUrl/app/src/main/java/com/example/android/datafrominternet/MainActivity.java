...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery(){
        String githubQuery = mSearchBoxEditText.getText().toString(); // Contents of search box
        java.net.URL search = NetworkUtils.buildUrl(githubQuery);
        mUrlDisplayTextView.setText(search.toString()); // Will set text of this view to search URL
    }
